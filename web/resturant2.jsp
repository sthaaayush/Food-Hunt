<html>
    ...
    <body>
        <section id="Home">
            <nav>
                <div class="logo">
                    <img src="resturant/r_imgs/bl.jpg" />
                </div>
                <ul>
            ...
            <div class="main">
                <div class="main_txt">
                    <h1>Eat Fresh<span>Baked Goodies</span><br />Daily</h1>
                </div>
                <div class="main_img">
                    <img src="resturant/r_imgs/b1.png" />
                </div>
            </div>
            <br />
            <br />
        ...
        <div class="about" id="About">
            <div class="about_main">
                <div class="image">
                    <img src="resturant/r_imgs/b0.jpg" />
                </div>
                <div class="about_txt">
        ...
        <div class="menu" id="Menu">
            ...
            <div class="menu_box">
                <%
                    String dish_name[] = {"Macaroon", "Brownie", "Cookie", "Cake", "CupCake", "Iced Americano", "Caramel Latte"};
                    int dish_price[] = {2000, 900, 1500, 750, 800, 1000, 250};
                    for (int i = 0; i < 7; i++) {
                %>
                <div class="menu_card">
                    <div class="menu_image">
                        <img src=<%="resturant/r_imgs/r2d" + (i + 1) + ".jpg"%> />
                    </div>
